...
//            int bestDistance = 0;
//            int startWindow = Math.max(0, currentPos - WINDOW_SIZE);
//            int maxPossibleLength = Math.min(MAX_MATCH_LENGTH, data.length - currentPos - 1);
//
...
//            }
//
//            if (maxMatchLength > 0 && maxPossibleLength > 0) {
//                int nextCharPos = currentPos + maxMatchLength;
//                byte nextChar = nextCharPos < data.length ? data[nextCharPos] : 0;
//                tokens.add(new Token(bestDistance, maxMatchLength, nextChar));
...
//        if (args.length < 3) {
//            System.out.println("Usage: java LZ77 <compress|decompress> <inputFile> <outputFile>");
//            return;
//        }
//
//        String mode = args[0];
